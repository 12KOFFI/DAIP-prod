...
(function () {
  ...
  function addActiveClass(element) {
    ...
    if (current === "") {
      // For root url
      if (element.getAttribute('href').indexOf("index.html.twig") !== -1) {    // Checking href of 'element' matching with 'index.html.twig'
  ...
  const current = location.pathname.split("https://nobleui.com/").slice(-1)[0].replace(/^\/|\/$/g, '');
